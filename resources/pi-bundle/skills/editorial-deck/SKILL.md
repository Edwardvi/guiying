---
name: editorial-deck
description: 生成横向翻页网页 PPT（单 HTML 文件），含 WebGL 背景、章节幕封、数据大字报、图片网格等模板。提供两种美学风格：① "电子杂志 × 电子墨水"（衬线 + 暖色 + 流体背景）适合人文/故事/文化类内容；② "瑞士国际主义"（无衬线 + 网格点阵 + 高亮色）适合数据/技术/产品发布。触发词：杂志风PPT、瑞士风、Swiss Style、横翻页、好看的设计感deck、发布会风格。
---
