---
name: pro-presentation
description: 全能型 HTML 演示工具包——36 种主题、15 套完整 deck 模板、31 种页面布局、27 种 CSS 入场动效 + 20 种 Canvas 特效、键盘导航、演讲者模式（S 键弹窗：当前页/下一页/逐字稿/计时器）。适合：技术分享、正式汇报、产品发布、路演、带讲稿的演讲场景。触发词：做PPT、幻灯片、演讲稿、技术分享、正式汇报、产品发布、presentation、deck、slide、带演讲者模式、有讲稿。
---

# pro-presentation — HTML PPT Studio
