---
name: design-deck
description: 花叔Design——专业设计工作流：任何新设计先出三个方向初稿给用户选，选定后执行并交付 HTML + PDF + 可编辑 PPTX。支持：幻灯片/演讲deck、高保真原型、动画/视频、信息图/可视化。自带 HTML→PPTX 导出管线（文字双击可编辑）。触发词：做设计、三方向选稿、要出PPTX、做个好看的、设计评审、原型、动画、需要专业设计。
---
