...
export class MessageRenderer {
  ...
  renderWelcome({ workspacePath } = {}) {
    ...
    this.container.innerHTML = `
      <div class="welcome">
        <div class="welcome-icon"><img src="icons/logo-dark.svg" alt="桂英 logo" class="tau-icon-welcome"></div>
        <p>Welcome to 桂英</p>
        <p class="hint">Type a message below to start chatting, or select a session from the sidebar.</p>
        ${workspaceHtml}
